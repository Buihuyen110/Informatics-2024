...
### Необходимо
1. Фильтровать и экспортировать заказы с адресами в России и сохранить в файл russian_orders.txt
2. Фильтровать и экспортировать заказы с правильным форматом номера телефона +7-XXX-XXX-XX-XX и сохранить в файл valid_orders.txt
